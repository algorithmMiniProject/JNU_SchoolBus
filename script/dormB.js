var Ttable9 = function(){
    ...
    var leftMinutes;
    var name = '<span style="font-weight:bold;">학생생활관B&nbsp;</span>';
    if(remainShuttle[0]==null){
        document.querySelector("#dormB").innerHTML= name + "운행이 종료됐습니다";
        ...
        document.querySelector("#dormB").innerHTML= name + parseInt(leftMinutes / 60) + " 시 " + leftMinutes % 60 +" 분 후 도착";}
