var Timetable12 = function(){
    ...
    var leftMinutes;
    var name = '<span style="font-weight:bold;">교양강의동A&nbsp;</span>';
    if(remainShuttle[0]==null){
        document.querySelector("#eduA").innerHTML= name + "운행이 종료됐습니다";
        ...
        document.querySelector("#eduA").innerHTML= name + parseInt(leftMinutes / 60) + " 시 " + leftMinutes % 60 +" 분 후 도착";}
