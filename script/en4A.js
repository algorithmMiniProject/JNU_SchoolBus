var Timetable11 = function(){
    ...
    var leftMinutes;
    var name = '<span style="font-weight:bold;">공대&nbsp;4호관A&nbsp;</span>';
    if(remainShuttle[0]==null){
        document.querySelector("#eng4A").innerHTML= name + "운행이 종료됐습니다";
        ...
        document.querySelector("#eng4A").innerHTML= name + parseInt(leftMinutes / 60) + " 시 " + leftMinutes % 60 +" 분 후 도착";}
