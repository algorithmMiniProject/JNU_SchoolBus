var Ttable5 = function(){
    ...
    var leftMinutes;
    var name = '<span style="font-weight:bold;">공대&nbsp;4호관B&nbsp;</span>';
    if(remainShuttle[0]==null){
        document.querySelector("#eng4B").innerHTML= name + "운행이 종료됐습니다";
        ...
        document.querySelector("#eng4B").innerHTML= name + parseInt(leftMinutes / 60) + " 시 " + leftMinutes % 60 +" 분 후 도착";}
