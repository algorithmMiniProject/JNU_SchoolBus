...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		var iwContent1_A = '<div style="padding:5px;">정문 A노선 버스시간표</div>'; // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
		// 인포윈도우를 생성합니다
		...
		//해양대1호관_A
		var iwContent3_A = '<div style="padding:5px;">해양대1호관 A노선 버스시간표</div>';
		...
		//본관_A
		var iwContent4_A = '<div style="padding:5px;">본관 A노선 버스시간표</div>';
		...
		//학생회관_A
		var iwContent5_A = '<div style="padding:5px;">학생회관 A노선 버스시간표</div>';
		...
		//인문대서쪽_A
		var iwContent6_A = '<div style="padding:5px;">인문대서쪽(학생생활관5호관) A노선 버스시간표</div>';
		...
		//학생생활관_A
		var iwContent7_A = '<div style="padding:5px;">학생생활관 A노선 버스시간표</div>';
		...
		//인문대동쪽(학생생활관5호관)_A
		var iwContent8_A = '<div style="padding:5px;">인문대동쪽 A노선 버스시간표</div>';
		...
		//중앙도서관_A
		var iwContent9_A = '<div style="padding:5px;">중앙도서관 A노선 버스시간표</div>';
		...
		//의전원_A
		var iwContent10_A = '<div style="padding:5px;">의전원 A노선 버스시간표</div>';
		...
		//공대4호관_A
		var iwContent11_A = '<div style="padding:5px;">공대4호관 A노선 버스시간표</div>';
		...
		//교양강의동_A
		var iwContent13_A = '<div style="padding:5px;">교양강의동 A노선 버스시간표</div>';
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//정문_B
		// 마커에 커서가 오버됐을 때 마커 위에 표시할 인포윈도우를 생성합니다
		var iwContent1_B = '<div style="padding:5px;">정문 B노선 버스시간표</div>'; // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
		// 인포윈도우를 생성합니다
		...
		//약학대학(구 제2도서관)_B
		var iwContent2_B = '<div style="padding:5px;">약학대학(구 제2도서관) B노선 버스시간표</div>';
		...
		//해양대1호관_B
		var iwContent3_B = '<div style="padding:5px;">해양대1호관 B노선 버스시간표</div>';
		...
		//교양강의동_B
		var iwContent4_B = '<div style="padding:5px;">교양강의동 B노선 버스시간표</div>';
		...
		//공대4호관_B
		var iwContent6_B = '<div style="padding:5px;">공대4호관 B노선 버스시간표</div>';
		...
		//의전원_B
		var iwContent7_B = '<div style="padding:5px;">의전원 B노선 버스시간표</div>';
		...
		//중앙도서관_B
		var iwContent8_B = '<div style="padding:5px;">중앙도서관 B노선 버스시간표</div>';
		...
		//인문대동쪽_B
		var iwContent9_B = '<div style="padding:5px;">인문대동쪽 B노선 버스시간표</div>';
		...
		//학생생활관_B
		var iwContent10_B = '<div style="padding:5px;">학생생활관 B노선 버스시간표</div>';
		...
		//인문대서쪽(학생생활관5호관)_B
		var iwContent11_B = '<div style="padding:5px;">인문대서쪽(학생생활관5호관) B노선 버스시간표</div>';
		...
		//학생회관_B
		var iwContent12_B = '<div style="padding:5px;">학생회관 B노선 버스시간표</div>';
		...
		//본관_B
		var iwContent13_B = '<div style="padding:5px;">본관 B노선 버스시간표</div>';
