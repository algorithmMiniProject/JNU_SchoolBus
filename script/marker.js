...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		var iwContent1_A = '<a href="javascript:Timetable1();"></a>'+'<div id="mainA">'+'</div>';
		...
		//약학대학(구 제2도서관)_A
		var iwContent2_A = '<a href="javascript:Timetable2();"></a>'+'<div id="selA">'+'</div>';
		...
		//해양대1호관_A
		var iwContent3_A = '<a href="javascript:Timetable3();"></a>'+'<div id="oceanA">'+'</div>';
		...
		//본관_A
		var iwContent4_A = '<a href="javascript:Timetable4();"></a>'+'<div id="admA">'+'</div>';
		...
		//학생회관_A
		var iwContent5_A = '<a href="javascript:Timetable5();"></a>'+'<div id="sthallA">'+'</div>';
		...
		//인문대서쪽_A
		var iwContent6_A = '<a href="javascript:Timetable6();"></a>'+'<div id="huwestA">'+'</div>';
		...
		//학생생활관_A
		var iwContent7_A = '<a href="javascript:Timetable7();"></a>'+'<div id="dormA">'+'</div>';
		...
		//인문대동쪽(학생생활관5호관)_A
		var iwContent8_A = '<a href="javascript:Timetable8();"></a>'+'<div id="hueastA">'+'</div>';
		...
		//중앙도서관_A
		var iwContent9_A = '<a href="javascript:Timetable9();"></a>'+'<div id="libA">'+'</div>';
		...
		//의전원_A
		var iwContent10_A = '<a href="javascript:Timetable10();"></a>'+'<div id="medA">'+'</div>';
		...
		//공대4호관_A
		var iwContent11_A = '<a href="javascript:Timetable11();"></a>'+'<div id="eng4A">'+'</div>';
		...
		//교양강의동_A
		var iwContent13_A = '<a href="javascript:Timetable12();"></a>'+'<div id="eduA">'+'</div>';
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//정문_B
		// 마커에 커서가 오버됐을 때 마커 위에 표시할 인포윈도우를 생성합니다
		var iwContent1_B = '<a href="javascript:Ttable1();"></a>'+'<div id="mainB">'+'</div>'; // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
		// 인포윈도우를 생성합니다
		...
		//약학대학(구 제2도서관)_B
		var iwContent2_B = '<a href="javascript:Ttable2();"></a>'+'<div id="selB">'+'</div>';
		...
		//해양대1호관_B
		var iwContent3_B = '<a href="javascript:Ttable3();"></a>'+'<div id="oceanB">'+'</div>';
		...
		//교양강의동_B
		var iwContent4_B = '<a href="javascript:Ttable4();"></a>'+'<div id="eduB">'+'</div>';
		...
		//공대4호관_B
		var iwContent6_B = '<a href="javascript:Ttable5();"></a>'+'<div id="eng4B">'+'</div>';
		...
		//의전원_B
		var iwContent7_B = '<a href="javascript:Ttable6();"></a>'+'<div id="medB">'+'</div>';
		...
		//중앙도서관_B
		var iwContent8_B = '<a href="javascript:Ttable7();"></a>'+'<div id="libB">'+'</div>';
		...
		//인문대동쪽_B
		var iwContent9_B = '<a href="javascript:Ttable8();"></a>'+'<div id="hueastB">'+'</div>';
		...
		//학생생활관_B
		var iwContent10_B = '<a href="javascript:Ttable9();"></a>'+'<div id="dormB">'+'</div>';
		...
		//인문대서쪽(학생생활관5호관)_B
		var iwContent11_B = '<a href="javascript:Ttable10();"></a>'+'<div id="huwestB">'+'</div>';
		...
		//학생회관_B
		var iwContent12_B = '<a href="javascript:Ttable11();"></a>'+'<div id="sthallB">'+'</div>';
		...
		//본관_B
		var iwContent13_B = '<a href="javascript:Ttable12();"></a>'+'<div id="admB">'+'</div>';
