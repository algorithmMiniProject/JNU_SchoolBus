var Ttable6 = function(){
    ...
    var leftMinutes;
    var name = '<span style="font-weight:bold;">의학대학B&nbsp;</span>';
    if(remainShuttle[0]==null){
        document.querySelector("#medB").innerHTML= name + "운행이 종료됐습니다";
        ...
        document.querySelector("#medB").innerHTML= name + parseInt(leftMinutes / 60) + " 시 " + leftMinutes % 60 +" 분 후 도착";}
