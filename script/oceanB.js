var Ttable3 = function(){
    ...
    var leftMinutes;
    var name = '<span style="font-weight:bold;">해양대&nbsp;1호관B&nbsp;</span>';
    if(remainShuttle[0]==null){
        document.querySelector("#oceanB").innerHTML= name + "운행이 종료됐습니다";
        ...
        document.querySelector("#oceanB").innerHTML= name + parseInt(leftMinutes / 60) + " 시 " + leftMinutes % 60 +" 분 후 도착";}
